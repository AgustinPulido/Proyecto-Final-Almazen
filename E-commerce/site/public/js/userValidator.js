...
addEventListener('load', function() {
    ...
    if (btnRegM) {
        btnRegM.addEventListener('click', function(event) {
            // VALIDACIÓN CAMPO EMAIL MODAL REGISTRO
            let HasAnyErrors = false;


            console.log("INICIO syncronico");
            ...
            // VALIDACIÓN DEL CAMPO REPETIR CONTRASEÑA DE LA VISTA REGISTRO
            ...
            // if (!HasAnyErrors) {
            //     fetch('/user/create', {
            //             // TODO: construir body y asignarlo aca    -> body:
            //             // TODO: transformarlo en post por temas de seguridad (envio de contraseña)
            //         })
            //         .then((res) => {
            //             if (res.error) {
            //                 // TODO: Mostrar el error en el modal, e.g. email duplicado
            //             } else {
            //                 // TODO: refrescar la pagina / cerrar el modal / hacer lo que sea que termine en que el usuario vea que se creo
            //             }
            //         })
            // }
        })
